 ...
 * @author Ashok
 * @dev This contract will perform transferring of tokens from one address to another and approve the operator address. 
 */
 ...
 * @title ERC1155 base contract
 * @author Ashok
 * @dev This contract will perform various operations like mint tokens with URI and will create multiple NFT's at a time. 
 */

contract ClixLogixNFTERC1155 is ERC1155 {
